...
public class Multiplication {
	public static class CooccurrenceMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			//input: movieB \t movieA=relationRelation
	...
	public static class RatingMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			//OutputKey = moive   OutoutValue = user:rating
			String[] line = value.toString().split(",");
	...
	public static class MultiplicationReducer extends Reducer<Text, Text, Text, DoubleWritable> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			//inputKey = movieB
            //inputValue = <movieA=relation, movieC=relation... userA:rating1, userB:rating2...>
            ...
            //inputKey = movieB
            //relationMap<movieA, relation>
            //ratingMap<user, rating>

            //outputKey = movieA: userId
            //outputValue = subRating <- relativeRelation * rating
            for (Map.Entry<String, Double> entry: relationMap.entrySet()){
                String movieA = entry.getKey();
                double relativeRating = entry.getValue();
                ...
                for (Map.Entry<String, Double> element: ratingMap.entrySet()){
                    ...
                    double outputValue = relativeRating * rating;
